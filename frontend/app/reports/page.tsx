...
export default function ReportsPage() {
  ...
  const insight =
    weekly?.average_afi > 70 ? "High stimulation levels detected. Consider balancing with calmer content."
      ...
      <div className="card-glass" style={{ padding: "2rem" }}>
        ...
        <ResponsiveContainer width="100%" height={240}>
          <LineChart data={trend}>
            ...
            <Line type="monotone" dataKey="afi" stroke="#a78bfa" strokeWidth={2.5}
      ...
      <div className="card-glass" style={{ padding: "1.5rem", borderColor: `${insightColor}33`, background: `${insightColor}10` }}>
        <div style={{ display: "flex", alignItems: "flex-start", gap: "1rem" }}>
          ...
          <div>
            ...
            <p className="sans" style={{ color: "var(--muted-mid)", fontSize: "0.95rem", lineHeight: 1.65 }}>{insight}</p>
          </div>
        </div>
      </div>
