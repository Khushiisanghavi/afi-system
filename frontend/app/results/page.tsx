...
export default function ResultsPage() {
  ...
  return (
    <div className="container-section" style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      {/* MODALITY BAR CHART */}
      <div className="card-glass" style={{ padding: "2.5rem", marginTop: "0.5rem" }}>
        ...
        <div className="card-glass" style={{ padding: "2.5rem" }}>
          ...
          <ResponsiveContainer width="100%" height={260}>
            <LineChart data={timelineData}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(167,139,250,0.12)" />
              <XAxis dataKey="scene" tick={{ fill: "#6b6890", fontSize: 12, fontFamily: "Inter" }} axisLine={false} tickLine={false} />
              <YAxis tick={{ fill: "#6b6890", fontSize: 12, fontFamily: "Inter" }} axisLine={false} tickLine={false} />
              <Tooltip
                contentStyle={{ background: "rgba(5, 5, 15, 0.9)", backdropFilter: "blur(12px)", border: "1px solid rgba(167,139,250,0.2)", borderRadius: "12px", color: "#f0f0f0" }}
                cursor={{ stroke: "rgba(167, 139, 250, 0.3)", strokeWidth: 2 }}
              />
              <Line
                type="monotone"
                dataKey="score"
