...
class AudioAnalyzer:
    """
    Handles audio extraction and feature analysis
    ...
    def extract_audio(self) -> None:
        ...
        Converts to mono WAV (best for librosa).
        """
        try:
            (
                ffmpeg
    ...
    def compute_amplitude_spike_ratio(self, y, threshold_multiplier: float = 2.5) -> float:
        """
        Calculates ratio of samples that exceed dynamic threshold.
        Indicates sharp audio spikes.
        """
    ...
    def compute_zero_crossing_rate(self, y) -> float:
        """
        Measures noisiness / high-frequency agitation.
        """
